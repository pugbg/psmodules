...
RequiredModules = @(@{ModuleName = 'Microsoft.PowerShell.Utility'; ModuleVersion = '3.1.0.0'; }, 
               ...
               @{ModuleName = 'TypeHelper'; ModuleVersion = '1.0.0.70'; }, 
...
PrivateData = @{
    ...
    VersionControl = '{"Hash":"065FAA8A5E917CC4CEBF3DF2502BDF4483CD570C81EF68E77ED41BA05271579A","HashAlgorithm":"SHA256","Version":"1.0.0.54"}'
