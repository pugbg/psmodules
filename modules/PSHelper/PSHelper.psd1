...
@{
    ...
    RequiredModules   = @(@{ModuleName = 'Microsoft.PowerShell.Utility'; ModuleVersion = '3.1.0.0'; }, 
        ...
        @{ModuleName = 'TypeHelper'; RequiredVersion = '1.0.0.75'; }, 
    ...
    PrivateData       = @{
        ...
        VersionControl = '{"Hash":"5BFA0DDAF092F3E2DD34AAD6A9638DE5D626F2BF5048AFF136DBA6763D31EFD7","HashAlgorithm":"SHA256","Version":"1.0.0.58"}'
