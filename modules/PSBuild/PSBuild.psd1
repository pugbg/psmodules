...
RequiredModules = @(@{ModuleName = 'TypeHelper'; ModuleVersion = '1.0.0.75'; }, 
               @{ModuleName = 'SystemExtensions'; ModuleVersion = '1.0.0.7'; }, 
               @{ModuleName = 'PowerShellGet'; ModuleVersion = '2.1.5'; }, 
               @{ModuleName = 'PSHelper'; ModuleVersion = '1.0.0.58'; }, 
               @{ModuleName = 'AstExtensions'; ModuleVersion = '1.0.0.8'; }, 
               @{ModuleName = 'PackageManagement'; ModuleVersion = '1.4.2'; })
...
PrivateData = @{
    ...
    VersionControl = '{"Hash":"1FAC3BF8372108FDF5D9E25314AE2FF606AFA73D6FBB69B5C364470B79392156","HashAlgorithm":"SHA256","Version":"1.0.1.120"}'
