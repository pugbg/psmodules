...
RequiredModules = @(@{ModuleName = 'TypeHelper'; ModuleVersion = '1.0.0.71'; }, 
               @{ModuleName = 'SystemExtensions'; ModuleVersion = '1.0.0.6'; }, 
               @{ModuleName = 'PowerShellGet'; ModuleVersion = '2.0.1'; }, 
               @{ModuleName = 'PSHelper'; ModuleVersion = '1.0.0.54'; }, 
               @{ModuleName = 'AstExtensions'; ModuleVersion = '1.0.0.8'; }, 
               @{ModuleName = 'PackageManagement'; ModuleVersion = '1.2.2'; })
...
PrivateData = @{
    ...
    VersionControl = '{"Hash":"3F1B87C9620128FC6E5C997249C440D2B94DAD512F9420BAD3DE0E36450F3510","HashAlgorithm":"SHA256","Version":"1.0.1.98"}'
