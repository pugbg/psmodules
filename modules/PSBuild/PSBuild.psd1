...
RequiredModules = @(@{ModuleName = 'TypeHelper'; ModuleVersion = '1.0.0.75'; }, 
               ...
               @{ModuleName = 'PowerShellGet'; ModuleVersion = '2.1.4'; }, 
               @{ModuleName = 'PSHelper'; ModuleVersion = '1.0.0.58'; }, 
               @{ModuleName = 'AstExtensions'; ModuleVersion = '1.0.0.8'; }, 
               @{ModuleName = 'PackageManagement'; ModuleVersion = '1.4.1'; })
...
PrivateData = @{
    ...
    VersionControl = '{"Hash":"C2E2899D813DF11E4406EFDFE2C64112F0A2CF4445F1B5ACE7E145B89EEC663A","HashAlgorithm":"SHA256","Version":"1.0.1.115"}'
