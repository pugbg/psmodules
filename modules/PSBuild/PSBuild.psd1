...
RequiredModules = @(@{ModuleName = 'TypeHelper'; RequiredVersion = '1.0.0.75'; }, 
               @{ModuleName = 'SystemExtensions'; RequiredVersion = '1.0.0.7'; }, 
               @{ModuleName = 'PowerShellGet'; RequiredVersion = '2.1.5'; }, 
               @{ModuleName = 'PSHelper'; RequiredVersion = '1.0.0.58'; }, 
               @{ModuleName = 'AstExtensions'; RequiredVersion = '1.0.0.8'; }, 
               @{ModuleName = 'PackageManagement'; RequiredVersion = '1.4.2'; })
...
PrivateData = @{
    ...
    VersionControl = '{"Hash":"35FE52E601EBE0E8B4CE4C98FB6B8725195A68BA13680CE97D4518E9D27382F6","HashAlgorithm":"SHA256","Version":"1.0.1.125"}'
